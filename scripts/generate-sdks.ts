...
generateSdk(
  file_capabilities_internal_basicaction_v1_basic_action,
  "./src/generated-sdk"
);

generateSdk(
  file_capabilities_internal_basictrigger_v1_basic_trigger,
  "./src/generated-sdk"
);

generateSdk(
  file_capabilities_internal_nodeaction_v1_node_action,
  "./src/generated-sdk"
);

generateSdk(
  file_capabilities_internal_consensus_v1alpha_consensus,
  "./src/generated-sdk"
);
...
generateSdk(
  file_capabilities_networking_http_v1alpha_trigger,
  "./src/generated-sdk"
);
