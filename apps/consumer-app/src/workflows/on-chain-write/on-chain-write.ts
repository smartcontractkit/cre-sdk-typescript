...
import type { NodeRuntime, Runtime } from "@chainlink/cre-sdk/runtime/runtime";
...
import { bytesToHex, hexToBase64 } from "@chainlink/cre-sdk/utils/hex-utils";
import { sendResponseValue } from "@chainlink/cre-sdk/utils/send-response-value";
import {
...
const onCronTrigger = async (
  ...
  runtime.logger.log(
    "Dry running call to ensure the value is not anomalous..."
  );
