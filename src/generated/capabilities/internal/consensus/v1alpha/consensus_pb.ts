...
import type { ReportRequestSchema, ReportResponseSchema, SimpleConsensusInputsSchema } from "../../../../sdk/v1alpha/sdk_pb";
...
export const Consensus: GenService<{
  ...
  serviceDesc(file_capabilities_internal_consensus_v1alpha_consensus, 0);
