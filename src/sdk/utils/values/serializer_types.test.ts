...
import type { NumericType, PrimitiveTypes, NonSerializable, CreSerializableNested, CreSerializable, TypeVerifier } from './serializer_types';
...
describe('test types', () => {
    ...
    test('CreSerializableNested', () => {
        ...
        verifyType<(a: number, b: RegExp) => boolean, CreSerializableNested<(a: number, b: RegExp) => boolean>>(true)
        ...
        verifyType<TestSerializableClassPrivateNonSerializableMembers, CreSerializableNested<TestSerializableClassPrivateNonSerializableMembers>>(true)
        ...
        verifyType<TestNonSerializableInterface, CreSerializableNested<TestNonSerializableInterface>>(false)
        verifyType<TestNonSerializableClass[], CreSerializableNested<TestNonSerializableClass[]>>(false)
    })
    ...
    test('CreSerializable', () => {
        ...
        verifyType<(a: number, b: RegExp) => boolean, CreSerializable<(a: number, b: RegExp) => boolean>>(false)
        ...
        verifyType<TestSerializableClassPrivateNonSerializableMembers, CreSerializable<TestSerializableClassPrivateNonSerializableMembers>>(true)
...
class TestSerializableClass {
    constructor(public a: string, public b: () => RegExp) { }
...
class TestSerializableClassPrivateNonSerializableMembers {
    constructor(public a: string, private b: RegExp, private readonly c : RegExp) { }
}
