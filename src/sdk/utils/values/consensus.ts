...
const consensusAggregators = ['median', 'identical', 'commonPrefix', 'commonSuffix'] as const
...
export const consensusDescriptorCommonPrefix = create(ConsensusDescriptorSchema, {
	descriptor: {
		case: 'aggregation',
...
export const consensusDescriptorCommonSuffix = create(ConsensusDescriptorSchema, {
	descriptor: {
		case: 'aggregation',
...
export const createConsensusDescriptorAggregation = (aggregation: AggregationType) =>
...
export const consensusFieldsFrom = (
	...
	for (const key of Object.keys(spec)) {
		...
		normalized[key] =
			typeof value === 'number' ? createConsensusDescriptorAggregation(value) : value
	}
	return consensusFields(normalized)
}

export type ObservationValueCase = Extract<SimpleConsensusInputs['observation'], { case: 'value' }>

export type ObservationErrorCase = Extract<SimpleConsensusInputs['observation'], { case: 'error' }>
 ...
 * ```
 */
export const getAggregatedValue = (value: Value, consensus: ConsenusAggregator) =>
