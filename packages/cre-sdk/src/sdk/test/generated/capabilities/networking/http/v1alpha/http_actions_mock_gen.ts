...
import { type Request, RequestSchema, type Response, type ResponseJson, ResponseSchema } from "@cre/generated/capabilities/networking/http/v1alpha/client_pb"
  ...
  private constructor() {
    ...
    try {
      ...
      case "SendRequest": {
        ...
        const output = raw && typeof (raw as unknown as { $typeName?: string }).$typeName === "string" ? (raw as Response) : fromJson(ResponseSchema, raw as ResponseJson);
