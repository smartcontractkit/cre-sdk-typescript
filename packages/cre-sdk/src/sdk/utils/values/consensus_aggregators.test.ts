...
function expectCase<
	C extends NonNullable<ConsensusDescriptor['descriptor']['case']>,
	V = Extract<NonNullable<ConsensusDescriptor['descriptor']>, { case: C }>['value'],
>(actual: ConsensusDescriptor, expectedCase: C): V {
...
class InvalidFieldType {
	constructor(
		public f1: string,
		public f2: string,
		public ignoreString: string,
		public ignoreRegExp: RegExp,
	) {}
}
...
function usableForFieldConsensus<T, U>(
	a: () => ConsensusFieldAggregation<T, U>,
): () => ConsensusFieldAggregation<T, U> {
	return a
}
