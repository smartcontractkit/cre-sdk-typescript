...
export type CapabilityMetadata = Message<'tools.generator.v1alpha.CapabilityMetadata'> & {
	...
	/**
	 * @generated from field: repeated tools.generator.v1alpha.AdditionalEnironments additional_environments = 4;
	 */
	additionalEnvironments: AdditionalEnironments[]
}
...
export type CapabilityMetadataJson = {
	 ...
	 * @generated from field: repeated tools.generator.v1alpha.AdditionalEnironments additional_environments = 4;
	 */
	additionalEnvironments?: AdditionalEnironmentsJson[]
}
...
/**
 * @generated from enum tools.generator.v1alpha.AdditionalEnironments
 */
export enum AdditionalEnironments {
	/**
 ...
 * @generated from enum tools.generator.v1alpha.AdditionalEnironments
 */
export type AdditionalEnironmentsJson =
	| 'ADDITIONAL_ENVIRONMENTS_UNSPECIFIED'
	| 'ADDITIONAL_ENVIRONMENTS_TEE'

/**
 * Describes the enum tools.generator.v1alpha.AdditionalEnironments.
 */
export const AdditionalEnironmentsSchema: GenEnum<
	AdditionalEnironments,
	AdditionalEnironmentsJson
