import type { Runtime, NodeRuntime } from "@cre/sdk"
...
export class PerformActioner {
	constructor(private readonly runtime: NodeRuntime<unknown>, private readonly client: BasicActionCapability) {}
...
export class BasicActionCapability {
  ...
  performAction(runtime: NodeRuntime<unknown>, input: NodeInputs | NodeInputsJson): {result: () => NodeOutputs}
  ...
  performAction(...args: unknown[]): unknown {
    ...
    if (typeof args[1] === 'function') {
      const [runtime, fn, consensusAggregation, unwrapOptions] = args as [Runtime<unknown>, (performActioner: PerformActioner, ...args: unknown[]) => unknown, ConsensusAggregation<unknown, true>, UnwrapOptions<unknown> | undefined]
  ...
  private performActionCallHelper(runtime: NodeRuntime<unknown>, input: NodeInputs | NodeInputsJson): {result: () => NodeOutputs} {
