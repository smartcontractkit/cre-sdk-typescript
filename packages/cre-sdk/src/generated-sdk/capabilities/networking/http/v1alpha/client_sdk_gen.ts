...
export class SendRequester {
	constructor(private readonly runtime: NodeRuntime<unknown>, private readonly client: ClientCapability) {}
...
export class ClientCapability {
  ...
  sendRequest(runtime: NodeRuntime<unknown>, input: Request | RequestJson): {result: () => Response}
  ...
  sendRequest(...args: unknown[]): unknown {
    ...
    if (typeof args[1] === 'function') {
      const [runtime, fn, consensusAggregation, unwrapOptions] = args as [Runtime<unknown>, (sendRequester: SendRequester, ...args: unknown[]) => unknown, ConsensusAggregation<unknown, true>, UnwrapOptions<unknown> | undefined]
  ...
  private sendRequestCallHelper(runtime: NodeRuntime<unknown>, input: Request | RequestJson): {result: () => Response} {
