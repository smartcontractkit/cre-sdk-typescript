...
export function x_generatedCodeOnly_wrap_WriteCreReportRequest(input: WriteReportRequest): WriteCreReportRequest {
		return {
...
export function createWriteCreReportRequest(input: WriteCreReportRequestJson): WriteCreReportRequest {
		return {
...
export function x_generatedCodeOnly_unwrap_WriteCreReportRequest(input: WriteCreReportRequest): WriteReportRequest {
...
export class ClientCapability {
  ...
  callContract(runtime: Runtime<unknown>, input: CallContractRequest | CallContractRequestJson): {result: () => CallContractReply} {
  ...
  filterLogs(runtime: Runtime<unknown>, input: FilterLogsRequest | FilterLogsRequestJson): {result: () => FilterLogsReply} {
    // Handle input conversion - unwrap if it's a wrapped type, convert from JSON if needed
  ...
  balanceAt(runtime: Runtime<unknown>, input: BalanceAtRequest | BalanceAtRequestJson): {result: () => BalanceAtReply} {
    // Handle input conversion - unwrap if it's a wrapped type, convert from JSON if needed
  ...
  estimateGas(runtime: Runtime<unknown>, input: EstimateGasRequest | EstimateGasRequestJson): {result: () => EstimateGasReply} {
    // Handle input conversion - unwrap if it's a wrapped type, convert from JSON if needed
  ...
  getTransactionByHash(runtime: Runtime<unknown>, input: GetTransactionByHashRequest | GetTransactionByHashRequestJson): {result: () => GetTransactionByHashReply} {
    // Handle input conversion - unwrap if it's a wrapped type, convert from JSON if needed
    ...
    if ((input as unknown as { $typeName?: string }).$typeName) {
      ...
      // It's regular JSON, convert using fromJson
      payload = fromJson(GetTransactionByHashRequestSchema, input as GetTransactionByHashRequestJson)
    }
    ...
    const capabilityResponse = runtime.callCapability<GetTransactionByHashRequest, GetTransactionByHashReply>({
      capabilityId,
  ...
  getTransactionReceipt(runtime: Runtime<unknown>, input: GetTransactionReceiptRequest | GetTransactionReceiptRequestJson): {result: () => GetTransactionReceiptReply} {
    // Handle input conversion - unwrap if it's a wrapped type, convert from JSON if needed
    ...
    if ((input as unknown as { $typeName?: string }).$typeName) {
      ...
      // It's regular JSON, convert using fromJson
      payload = fromJson(GetTransactionReceiptRequestSchema, input as GetTransactionReceiptRequestJson)
    }
    ...
    const capabilityResponse = runtime.callCapability<GetTransactionReceiptRequest, GetTransactionReceiptReply>({
      capabilityId,
  ...
  headerByNumber(runtime: Runtime<unknown>, input: HeaderByNumberRequest | HeaderByNumberRequestJson): {result: () => HeaderByNumberReply} {
    // Handle input conversion - unwrap if it's a wrapped type, convert from JSON if needed
  ...
  writeReport(runtime: Runtime<unknown>, input: WriteCreReportRequest | WriteCreReportRequestJson): {result: () => WriteReportReply} {
    // Handle input conversion - unwrap if it's a wrapped type, convert from JSON if needed
    ...
    if ((input as unknown as { $report?: boolean }).$report) {
      ...
      payload = x_generatedCodeOnly_unwrap_WriteCreReportRequest(createWriteCreReportRequest(input as WriteCreReportRequestJson))
    }
