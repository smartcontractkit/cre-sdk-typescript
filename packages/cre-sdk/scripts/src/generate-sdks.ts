...
import { file_capabilities_blockchain_stellar_v1alpha_client } from '@cre/generated/capabilities/blockchain/stellar/v1alpha/client_pb'
...
export const main = () => {
	...
	generateSdk(file_capabilities_blockchain_stellar_v1alpha_client, './src/generated-sdk')
	allMockExports.push(
		...generateMocks(file_capabilities_blockchain_stellar_v1alpha_client, TEST_GENERATED_DIR),
	)
