...
import { file_capabilities_internal_consensus_v1beta_consensus } from '@cre/generated/capabilities/internal/consensus/v1beta/consensus_pb'
...
export const main = () => {
	...
	generateSdk(file_capabilities_internal_consensus_v1beta_consensus, './src/generated-sdk')
